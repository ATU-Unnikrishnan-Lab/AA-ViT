...
class Visualizer():
    ...
    def imresize(image, size, interp='bicubic'):
        pil_interpolation = {
        ...
        interp_method = pil_interpolation.get(interp, Image.BICUBIC)
        return np.array(Image.fromarray(image).resize(size, interp_method))
